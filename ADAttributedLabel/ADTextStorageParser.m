...
@implementation ADTextStorageParser
    ...
    if (jsonArray) {
        ...
        if ([jsonArray isKindOfClass:[NSArray class]]){
            ...
            for (NSDictionary *dic in jsonArray) {
                ...
                id<ADAppendTextStorageProtocol> textStorage = nil;
...
+ (id<ADAppendTextStorageProtocol>)parseTextStorageFromDictinary:(NSDictionary *)dic
{
...
+ (id<ADDrawStorageProtocol>)parseImageRunFromDictinary:(NSDictionary *)dic
{
    ADImageStorage *imageStorage = [[ADImageStorage alloc]init];
    imageStorage.imageName = dic[@"name"];
    imageStorage.imageAlignment = ADImageAlignmentRight;
    imageStorage.size = CGSizeMake([dic[@"width"] doubleValue], [dic[@"height"] doubleValue]);

    return imageStorage;
}

+ (id<ADAppendTextStorageProtocol>)parseLinkRunFromDictinary:(NSDictionary *)dic
{
    ADLinkTextStorage *linkStorage = [[ADLinkTextStorage alloc]init];
