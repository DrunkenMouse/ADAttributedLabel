...
@interface AutoLayoutViewController () <ADAttributedLabelDelegate>
@property (nonatomic, strong) ADAttributedLabel *label1;
@property (nonatomic, strong) ADAttributedLabel *label2;
...
{
    ADAttributedLabel *label = [ADAttributedLabel new];
...
- (void)appendTextToLabel:(ADAttributedLabel *)label
{
...
- (void)appendImageToLabel:(ADAttributedLabel *)label
{
    // 追加 图片Url
...
- (void)attributedLabel:(ADAttributedLabel *)attributedLabel textStorageClicked:(id<ADTextStorageProtocol>)textStorage atPoint:(CGPoint)point
{
    ...
    ADAttributedLabel *addedLabel = (arc4random()%2==0)?self.label1:self.label2;
    if (addText) {
