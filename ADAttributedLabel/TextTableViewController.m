...
@interface TextTableViewController ()<ADAttributedLabelDelegate>
...
- (void)addTableViewItems {
    ...
    for (NSInteger i = 0; i < 16; ++i) {
        [tmp addObject:[self createTextContainer]];
    }
    _textContainers = [tmp copy];
}

- (ADTextContainer *)createTextContainer {
...
{
    ADTextContainer *textContaner = _textContainers[indexPath.row];
