...
- (NSString *)pathOnDiskForName:(NSString *)imageName {
    return [self.localDirectory stringByAppendingPathComponent:[ADImageCache md5:imageName]];
}
...
- (void)imageForURL:(NSString *)imageURL needThumImage:(BOOL)needThumImage found:(void (^)(UIImage *))found notFound:(void (^)())notFound {
